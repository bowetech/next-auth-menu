...
const MobileMenu = ({ links = [], show = false, onClose = () => null }) => {
	...
	console.log("Show Mobile Menu?", show);
					...
					<div className="px-5 pt-4 pb-6 space-y-8">
						...
						<div className="-mr-2">
							<button
								type="button"
								onClick={onClose}
								className="rounded-md p-2 inline-flex justify-center items-center focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-600"
							>
